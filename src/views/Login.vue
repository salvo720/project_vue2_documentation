...
<template>
  <div id="app" class="container-fluid">
    <div class="row padding_top_150px">
...
export default {
  ...
  data() {
    return {
      ...
      remember_me_check: "",
      link_php_page_login:
        "http://localhost:8080/project_vue2_documentation/vue_cdn/vue_crud/back_end_api.php?action=login",
      save_token: "",
    };
  },
  created: function () {},
  ...
  methods: {
    ...
    render_form() {
      ...
      axios.post(this.link_php_page_login, formdata).then((response) => {
        ...
        if (response.data.error) {
          ...
          if (this.SuccessMsg == true) {
            this.save_token = response.data.token;

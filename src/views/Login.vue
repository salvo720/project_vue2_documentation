...
<template>
    <div id="app" class="container-fluid">
        ...
        <div class="row padding_bottom_200px">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <form v-on:submit.prevent="render_form()">
                        ...
                        <div class="form-outline mb-4">
                            <input v-model.lazy="email" type="email" id="id_email" class="form-control form-control-lg" placeholder="Enter a valid email address" />
                            <label class="form-label" for="id_email">Email address</label>
                        </div>

                        <!-- Password input -->
                        <div class="form-outline mb-3">
                            <input v-model.lazy="password" type="password" id="id_passowrd" class="form-control form-control-lg" placeholder="Enter password" />
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <input class="form-check-input me-2" type="checkbox" v-model="remember_me_check" true-value="yes" false-value="no" id="form2Example3" />
    ...
    methods : {
        ...
        render_form (){
          ...
          // alert('processing')
            ...
            window.console.log(' email vale : ' + this.email )
            ...
            axios.post(this.link_php_page_login, formdata
                ...
                this.ErrorMsg = response.data.message;
                    ...
                    window.console.log( this.SuccessMsg);

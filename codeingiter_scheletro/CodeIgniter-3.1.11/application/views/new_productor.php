...
<div class="container">
    <form class="row g-3" method="POST" action="<?php echo site_url('Produttori_Crud_Controller/insert_new_productor'); ?>">

    <!-- form elelemti visibili -->
    <div class="col-md-4">
        <label for="Nome_elemento" class="form-label">Nome Produttore</label>
        <input type="text" name="Nome_Produttore" class="form-control" id="id_Nome_elemento">
    </div>
    <div class="col-md-4">
        <label for="Numero_elemento" class="form-label">Numero Partita Iva Produttore</label>
        <input type="text" name="Numero_Partita_Iva_Produttore" class="form-control" id="id_Numero_elemento"  >
    </div>
    <div class="col-4">
        <label for="Tipologia" class="form-label">Id Elemento</label>
        <input type="text" name="Id_Elemento" class="form-control" id="id_Tipologia" >
    </div>
    <div class="col-12">

...
class Element_Model extends CI_Model {
    ...
    public function detail_element($id){
        $this->db->select('elemento.id , elemento.nome , elemento.numero , elemento.tipologia ,  elemento.quantita ,  elemento.prezzo ,  produttori.id as id_produttore , ,  produttori.nome_produttore ,  produttori.partita_iva_produttore');
        $this->db->from('elemento');
